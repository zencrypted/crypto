...
@usableFromInline struct DirectoryAbstractService_ServiceControls_manageDSAITPlaneRef_Sequence: DERImplicitlyTaggable, Sendable {
    ...
    @usableFromInline var dsaName: InformationFramework_Name
    @usableFromInline var agreementID: DirectoryAbstractService_AgreementID
    @inlinable init(dsaName: InformationFramework_Name, agreementID: DirectoryAbstractService_AgreementID) {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let dsaName: InformationFramework_Name = try InformationFramework_Name(derEncoded: &nodes)
