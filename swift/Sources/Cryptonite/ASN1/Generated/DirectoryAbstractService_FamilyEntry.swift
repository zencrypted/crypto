...
@usableFromInline struct DirectoryAbstractService_FamilyEntry: DERImplicitlyTaggable, Sendable {
    ...
    @usableFromInline var rdn: InformationFramework_RelativeDistinguishedName
    ...
    @inlinable init(rdn: InformationFramework_RelativeDistinguishedName, information: [DirectoryAbstractService_FamilyEntry_information_Choice], family_info: [DirectoryAbstractService_FamilyEntries]?) {
        self.rdn = rdn
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            let rdn: InformationFramework_RelativeDistinguishedName = try InformationFramework_RelativeDistinguishedName(derEncoded: &nodes)
