...
@usableFromInline struct LDAP_SearchRequest: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(baseObject: LDAP_LDAPDN, scope: LDAP_SearchRequest_scope_Enum, derefAliases: LDAP_SearchRequest_derefAliases_Enum, sizeLimit: ArraySlice<UInt8>, timeLimit: ArraySlice<UInt8>, typesOnly: Bool, filter: LDAP_Filter, attributes: LDAP_AttributeSelection) {
